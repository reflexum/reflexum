...
- Готовый установочный архив: [последний GitHub Release](https://github.com/reflexum/reflexum/releases/latest)
...
1. Скачайте последний `reflexum-<version>.zip` из [GitHub Releases](https://github.com/reflexum/reflexum/releases/latest).
